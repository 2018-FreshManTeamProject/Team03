...
namespace Oikake.Device
{
    class Renderer
    {
        ...
        public void LoadContent(string assetName, Texture2D texture)
        {
            ...
            {
#if DEBUG
                Console.WriteLine(assetName + "はすでに読み込まれてます。" + "プログラムを確認してください");
        ...
        {
            spriteBatch.Draw(textures[assetName], position, rect, Color.White * alpha, rotate, rotatePosition, scale, effects, depth);
        }
    }
}
